...
namespace DBapplication
{
    public class DBManager
    {
        ...
        static string DB_Connection_String = @"Data Source=LAPTOP-MOMUL1OT\SQLEXPRESS01;Initial Catalog=ArtManagementSystem;Integrated Security=True;Encrypt=False";
