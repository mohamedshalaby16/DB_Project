...
INSERT INTO Reviews (UserID, ArtworkID, Comment, Rating) VALUES
(1, 1, 'A surreal masterpiece!', 5),
(2, 1, 'Thought-provoking and unique.', 4),
(3, 2, 'The night sky comes alive.', 5),
(4, 2, 'Vivid and enchanting.', 4),
(5, 3, 'A timeless depiction of unity.', 5),
(6, 3, 'Historical and emotional.', 5),
(7, 4, 'An enigmatic beauty.', 5),
(8, 4, 'The smile is captivating.', 4),
(9, 5, 'A powerful anti-war message.', 5),
(10, 5, 'Emotionally intense.', 4),
(11, 6, 'Calming and serene.', 5),
(12, 6, 'Nature at its finest.', 1),
(13, 7, 'Hauntingly beautiful.', 5),
(14, 7, 'The anguish is palpable.', 4),
(15, 8, 'Iconic and inspirational.', 2),
(16, 8, 'A spiritual marvel.', 3),
(17, 9, 'Simple yet profound.', 5),
(18, 9, 'A charming portrait.', 4),
(19, 10, 'Dynamic and dramatic.', 5),
(20, 10, 'Bold and striking.', 4),
(1, 11, 'Captures the essence of pop art.', 5),
(2, 11, 'Playful and clever.', 4),
(3, 12, 'A deeply personal work.', 5),
(4, 12, 'Full of raw emotion.', 4),
(5, 13, 'Bright and cheerful.', 5),
(6, 13, 'Pure sunshine in a frame.', 3),
(7, 14, 'Intriguing and geometric.', 5),
(8, 14, 'A symphony of shapes.', 4),
(9, 15, 'Energetic and modern.', 2),
(10, 15, 'A vibrant urban landscape.', 1);



INSERT INTO VerificationRequest ( UserID, ArtworkID, RequestDate, VerificationStatus) VALUES
( 1, 1, '2023-10-01', 'Pending'),
( 2, 2, '2023-10-05', 'Approved'),
( 3, 3, '2023-10-10', 'Rejected'),
( 4, 4, '2023-10-15', 'Approved'),
( 5, 5, '2023-10-20', 'Pending'),
( 6, 6, '2023-10-25', 'Rejected'),
( 7, 7, '2023-10-30', 'Approved'),
( 8, 8, '2023-11-01', 'Pending'),
( 9, 9, '2023-11-05', 'Approved'),
( 10, 10, '2023-11-10', 'Rejected'),
( 11, 11, '2023-11-15', 'Pending'),
( 12, 12, '2023-11-20', 'Approved'),
( 13, 13, '2023-11-25', 'Rejected'),
( 14, 14, '2023-11-30', 'Approved'),
( 15, 15, '2023-12-01', 'Pending'),
( 16, 16, '2023-12-05', 'Approved'),
( 17, 17, '2023-12-10', 'Rejected'),
( 18, 18, '2023-12-15', 'Approved'),
( 19, 19, '2023-12-20', 'Pending'),
( 20, 20, '2023-12-25', 'Approved');



INSERT INTO AuctionHouse ( GalleryID, ArtworkID, Name, SellingPrice) VALUES
( 1, 1, 'Winter Wonders Auction', 500000),
( 2, 2, 'Spring Delights Auction', 700000),
( 3, 3, 'Summer Showcase Auction', 1500000),
( 4, 4, 'Autumn Elegance Auction', 2000000),
( 5, 5, 'Holiday Specials Auction', 1200000),
( 6, 6, 'Collector’s Gems Auction', 800000),
( 7, 7, 'Art World’s Finest Auction', 250000),
( 8, 8, 'Masterpieces of Time Auction', 1800000),
( 9, 9, 'Abstract Icons Auction', 450000),
( 10, 10, 'Pop Art Parade Auction', 300000),
( 1, 11, 'Sculpture Spotlight Auction', 900000),
( 2, 12, 'Cultural Heritage Auction', 650000),
( 3, 13, 'Dutch Masters Auction', 500000),
( 4, 14, 'Impressionist Marvels Auction', 1000000),
( 5, 15, 'Surreal Wonders Auction', 700000),
( 6, 16, 'Expressionist Highlights Auction', 400000),
